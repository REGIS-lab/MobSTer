starting_URL = 'http://127.0.0.1:8080/WebGoat/attack?Screen=20&menu=900&stage=1'
#starting_URL = 'http://127.0.0.1:8080/WebGoat/attack?Screen=20&menu=900&stage=5' # Where the test starts
